...
flowchart TD
    subgraph OPCION1 ["OPCIÓN A: KYC HEREDADO DEL EMISOR (Cero Costo & Cero Fricción)"]
        ...
        A2 --> A3["Motor PSP Aliado solo valida la CLABE vía SPEI ($0.01 MXN)"]
    end
...
* **El Flujo:** El comercio solo ingresa su número celular + su CLABE Interbancaria de Spin. La plataforma de Motor PSP Aliado únicamente realiza un envío de validación por SPEI de $0.01 MXN para certificar la titularidad.
...
| :--- | :--- | :--- |
| **Modelo 1: CAC del Procesador (Motor PSP Aliado)** | **Motor PSP Aliado Engine** | Se absorbe como Costo de Adquisición de Cliente (CAC). Se recupera en la **primera transacción del turista** (con un cobro de $85 USD, la comisión cubre los $15 MXN del KYC). |
...
>
> *Para el 20% restante que requiere verificación biométrica directa, el costo de **$12 Pesos MXN** es absorbido por **Motor PSP Aliado como costo de adquisición (CAC)** y se amortiza en el primer cobro del turista."*
